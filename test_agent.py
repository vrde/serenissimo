...
'''
        ...
        self.assertEqual(urls, [
            ['https://vaccinicovid.regione.veneto.it/ulss0/azione/controllocf/corte/152', 'Vulnerabili'],
            ['https://vaccinicovid.regione.veneto.it/ulss0/azione/controllocf/corte/153', 'Persone con disabilità grave (L. 104 art. 3 c.3)'],
            ['https://vaccinicovid.regione.veneto.it/ulss0/azione/controllocf/corte/154', 'Over 80'],
            ['https://vaccinicovid.regione.veneto.it/ulss0/azione/controllocf/corte/1120', 'Oncologici']
        ])
	...
	<script>toggolaelem();</script>'''
        ...
        urls = agent.extract_urls(html, 0)
        self.assertEqual(urls, [
			['https://vaccinicovid.regione.veneto.it/ulss0/azione/sceglisede/servizio/101', 'Estremamente vulnerabili nati prima del 1951'],
			['https://vaccinicovid.regione.veneto.it/ulss0/azione/sceglisede/servizio/614', 'Vulnerabili e Disabili (R)']
        ])
